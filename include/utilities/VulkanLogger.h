...
namespace utils
{
    class VULKANRENDERER_EXPORTS VulkanValidationLayerLogger : public Singleton<VulkanValidationLayerLogger>
    {
    public:
    ...
    class VULKANRENDERER_EXPORTS VulkanRendererApiLogger : public Singleton<VulkanRendererApiLogger>
    {
    public:
