...
void VulkanRenderer::pickPhysicalDevice()
{
	...
	auto l_isDeviceSuitable = [this](
		...
		QueueFamilyIndices queueFamilyIndices = VulkanHelpers::findQueueFamilyIndices( physicalDevice, surface );
		...
		auto l_checkSwapChainAdequacy = [this]( 
			...
			SwapChainSupportDetails swapChainDetails = VulkanHelpers::querySwapChainSupport( physicalDevice, surface );
...
)
{
	...
	if( VulkanRenderer::ENABLE_VALIDATION_LAYER )
	{
